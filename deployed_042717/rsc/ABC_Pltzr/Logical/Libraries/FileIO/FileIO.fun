...
FUNCTION_BLOCK FileCreate				(*creates a file; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK FileOpen					(*opens a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pFile		: UDINT;			(*pointer to the file name*)
...
FUNCTION_BLOCK FileClose				(*closes an open file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the created file*)
	END_VAR
...
FUNCTION_BLOCK FileRead					(*reads from an open file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the created file*)
		offset		: UDINT;			(*offset*)
...
FUNCTION_BLOCK FileReadEx				(*reads from an open file and returns the number of actually read bytes; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the created file*)
		offset		: UDINT;			(*offset*)
...
FUNCTION_BLOCK FileWrite				(*writes to a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the created file*)
		offset		: UDINT;			(*offset*)
...
FUNCTION_BLOCK FileWriteEx				(*writes to a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the created file*)
		offset		: UDINT;			(*offset*)
...
FUNCTION_BLOCK FileRename				(*renames files; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK FileCopy					(*copies a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
...
FUNCTION_BLOCK FileDelete				(*deletes a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*pointer to the file name*)
...
FUNCTION_BLOCK FileInfo					(*gets information about a file; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK FileTruncate				(*truncates a file's length; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*file name given as pointer*)
...
FUNCTION_BLOCK DirCreate				(*creates a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK DirOpen					(*opens a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*pointer to the directory name*)
...
FUNCTION_BLOCK DirClose					(*closes a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the directory*)
	END_VAR
...
FUNCTION_BLOCK DirRead					(*reads the individual file names in a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK DirReadEx				(*reads the individual file or directory names in a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		ident		: UDINT;			(*identifier of the directory*)
		pData		: UDINT;			(*pointer to the memory area where the information is copied*)
...
FUNCTION_BLOCK DirInfo					(*gets information about a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK DirRename				(*renames directories; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*pointer to the directory name*)
...
FUNCTION_BLOCK DirCopy					(*copies a directory*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pSrcDev		: UDINT;			(*pointer to the source file device name*)
...
FUNCTION_BLOCK DirDelete				(*deletes a directory; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*pointer to the directory name*)
...
FUNCTION_BLOCK DirDeleteEx				(*deletes a directory (all files and subdirectories); asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pName		: UDINT;			(*pointer to the directory name*)
...
FUNCTION_BLOCK SetAttributes			(*sets attributes; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK GetAttributes			(*reads attributes; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
		pPath		: UDINT;			(*pointer to the path name (file or directory)*)
...
FUNCTION_BLOCK DevMemInfo				(*determines a file device's memory information; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
	END_VAR
...
FUNCTION_BLOCK DevLink					(*creates the file device; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
...
FUNCTION_BLOCK DevUnlink				(*unlinks the device; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		handle		: UDINT;			(*file device handle*)
	END_VAR
...
FUNCTION_BLOCK GetVolumeLabel			(*reads volume label; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
...
FUNCTION_BLOCK GetVolumeSerialNo		(*reads volume serial nummer; asynchronous execution*)
	VAR_INPUT
		enable		: BOOL;				(*enables execution*)
		pDevice		: UDINT;			(*device name given as a pointer*)
	END_VAR
