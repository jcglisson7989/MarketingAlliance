...
/* Constants */
 ...
 _IEC_CONST unsigned short fiERR_INVALID_NBYTES = 20735U;
 _IEC_CONST unsigned short fiERR_NETIO_USER = 20734U;
 _IEC_CONST unsigned short fiERR_NETIO_PORT = 20733U;
 _IEC_CONST unsigned short fiERR_NETIO_IP_UNEQUAL = 20732U;
 ...
 _IEC_CONST unsigned long fiTruncate = 1U;
...
void FileWriteEx(struct FileWriteEx* inst);
void FileRename(struct FileRename* inst);
void FileCopy(struct FileCopy* inst);
void FileDelete(struct FileDelete* inst);
void FileInfo(struct FileInfo* inst);
void FileTruncate(struct FileTruncate* inst);
...
void GetVolumeLabel(struct GetVolumeLabel* inst);
void GetVolumeSerialNo(struct GetVolumeSerialNo* inst);
