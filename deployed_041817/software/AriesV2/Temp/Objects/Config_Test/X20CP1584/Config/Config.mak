...
$(AS_CPU_PATH)/Config.br: \
	$(AS_PROJECT_CPU_PATH)/mapp/Config.mpaxisbasic \
 	FORCE 
	@"$(AS_BIN_PATH)/BR.AS.SystemConfiguration.Builder.exe"   "$(AS_PROJECT_CPU_PATH)/mapp/Config.mpaxisbasic" -o "$(AS_CPU_PATH)/Config.br" -zip  -extOptions -D $(AS_CONFIGURATION) -B B4.26 -L "MpCom: V1.60.1" -z 1.60.1 -P "$(AS_PROJECT_PATH)" -c "$(AS_CONFIGURATION)" -secret "$(AS_PROJECT_PATH)_br.as.systemconfiguration.builder.exe"
