...
FUNCTION_BLOCK MpAlarmBasic (*mapp component for a basic centralized alarm collection and management*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpAlarmBasicUI (*mapp component for connecting alarms to the VC4 alarm system*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION MpAlarmReaction : BOOL (*Indicates whether one of the filtered reactions is active*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
...
FUNCTION MpAlarmSet : DINT (*Add-On function to set (raise) a user alarm. By calling this function the alarm system is informed that a specific alarm is active. Returns result code.*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
		MpLink : MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
...
FUNCTION MpAlarmReset : DINT (*Add-On function to reset a user alarm. By calling this function the alarm system is informed that a specific alarm is inactive. Returns result code.*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
		MpLink : MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpAlarmRegUser (*Add-On function block used to register user alarms with an empty mapp component*) (* $GROUP=mapp,$CAT=VC Alarm Extension,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpAlarm.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
