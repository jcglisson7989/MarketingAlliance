...
FUNCTION_BLOCK MpFileManagerUI (*File management system and UI connection to VC4*) (* $GROUP=mapp,$CAT=File Explorer,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpFile.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpFileManagerConfig (*mapp component for read/write component configuration*) (* $GROUP=mapp,$CAT=File Explorer,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpFile.png *)
	VAR_INPUT
