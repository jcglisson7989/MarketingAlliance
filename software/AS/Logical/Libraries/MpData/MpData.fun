...
FUNCTION_BLOCK MpDataRecorder (*Logs PVs and stores them in a .csv file*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
	...
	END_VAR
	VAR
		Internal : MpComInternalDataType; (*Internal information *) (* *) (*#OMIT#;*)
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK MpDataRecorderConfig (*Configuration for data recorder*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpDataRegParLimits (*Registers process variables for logging*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpDataRegPar (*Registers process variables for logging*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpDataStatisticsUI (*Logs PVs and stores them in a .csv file*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpDataTableUI (*Logs PVs and stores them in a .csv file*) (* $GROUP=mapp,$CAT=PV Value Sampling,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpData.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
