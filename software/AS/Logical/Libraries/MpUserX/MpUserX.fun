...
FUNCTION_BLOCK MpUserXLogin (*Login and logout users (via the application)*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
	...
	END_VAR
	VAR
		Internal : MpUserXInternalType; (*Internal stucture*)
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK MpUserXManagerUI (*UI connection for VC4 user management page*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
		UISetup : MpUserXMgrUISetupType := (0); (*Used to configure the elements connected to the HMI application*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpUserXLoginUI (*UI connection for VC4 login/logout page*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION MpUserXLevel : DINT (*Returns the level of the user who is currently logged in*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
	END_VAR
END_FUNCTION

FUNCTION MpUserXAccessRight : MpUserXAccessRightEnum (*Returns the access rights of the user who is currently logged in*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
...
FUNCTION MpUserXHasRole : BOOL (*Returns whether the currently logged in user has the given role*)
	VAR_INPUT
		MpLink : MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Role : WSTRING[50];
	END_VAR
...
FUNCTION_BLOCK MpUserXConfig (*Configuration for user management*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
	...
	END_VAR
	VAR
		Internal : MpComInternalDataType; (*Internal information *)
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK MpUserXLoginConfig (*Configuration for the login/logout behavior*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpUserXSignatureUI (*UI-Interface for electronic signature*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpUserXSignature (*Check electronic signature*) (* $GROUP=mapp,$CAT=User Role Manager,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpUserX.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets function block errors*) (* *) (*#PAR#;*)
