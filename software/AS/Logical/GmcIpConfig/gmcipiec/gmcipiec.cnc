...
<Root LangModule="ailgcode" Version="1.0">
  ...
  <BuiltInFns>
    ...
    <TRUNC ReturnType="IEC_INT" ArgType1="FLOAT" Inline="Yes">ToInt(:Fix(:$[1]:):)</TRUNC>
  ...
  <ParserData NestedComments="No" DefaultCaseSensitive="Yes" CommentsSpanLines="Yes"
    ...
    <TKG_PROG_NAME IsPattern="Yes" EndRuleToken="Yes">_INIT:[^\w\d]|_CYCLIC:[^\w\d]|_EXIT:[^\w\d]|_MAIN:[^\w\d]</TKG_PROG_NAME>
