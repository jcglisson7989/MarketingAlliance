...
/* Constants */
 ...
 #define DEFINE_MAX_TABLE_ENTRIES 16U
...
{	plcstring listHeader[81];
	plcstring listIdText[17][5];
	plcstring listTypeText[17][81];
	plcstring listDefaultText[17][81];
	plcstring listMinText[17][81];
	plcstring listMaxText[17][81];
	plcstring listValueText[17][81];
	plcstring listName[17][81];
	plcstring listDescription[17][241];
	unsigned long listValuePtr[17];
	signed long listDecPlaces[17];
	struct hmiParamLimits_typ listLimits[17];
