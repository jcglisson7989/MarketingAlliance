...
export AS_CPU_PATH_2 := C:/Users/jcgli/Desktop/software_Aries_040717/AriesV2/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	FORCE
	@"$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe" "$(AS_PROJECT_PATH)/AriesV2.apj" -t "$(AS_TEMP_PATH)" -o "$(AS_BINARIES_PATH)" -c "$(AS_CONFIGURATION)" -i "C:/BrAutomation/AS42" -S "X20CP1382"   -A "X20CP1382" -pil   -swFiles "$(AS_PROJECT_PATH)/Physical/Config_Test/X20CP1382/Cpu.sw" -Z "GMC: 3.16.2, mapp: 1.60.1, mappView: 1.2.1, TextSystem: n.d, Connectivity: n.d, AAS: n.d" -C "/RT=1000 /AM=* /SDT=5 /DAIP=192.168.10.10 /REPO=11159 /ANSL=1 /PT=11169" -D "/IF=tcpip /LOPO=11159 /SA=1" -M IA32 -T SG4
