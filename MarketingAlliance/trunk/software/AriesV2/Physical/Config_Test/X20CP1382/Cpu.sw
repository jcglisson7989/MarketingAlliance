...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  <TaskClass Name="Cyclic#1">
    <Task Name="ForceIO" Source="HMI.ForceIO.prg" Memory="UserROM" Language="IEC" Debugging="true" Disabled="true" />
    <Task Name="Creaser" Source="Application.Creaser.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="ForceIO1" Source="HMI.ForceIO.prg" Memory="UserROM" Language="IEC" Debugging="true" Disabled="true" />
  </TaskClass>
