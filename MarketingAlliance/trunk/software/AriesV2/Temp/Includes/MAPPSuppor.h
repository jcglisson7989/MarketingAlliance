...
/* Constants */
 ...
 #define DEFINE_MAX_IDX_HMI_TABLES 1U
 #define DEFINE_MAX_TABLE_ENTRIES 26U
...
{	plcstring listHeader[81];
	plcstring listIdText[27][5];
	plcstring listTypeText[27][81];
	plcstring listDefaultText[27][81];
	plcstring listMinText[27][81];
	plcstring listMaxText[27][81];
	plcstring listValueText[27][81];
	plcstring listName[27][81];
	plcstring listDescription[27][241];
	unsigned long listValuePtr[27];
	signed long listDecPlaces[27];
	struct hmiParamLimits_typ listLimits[27];
