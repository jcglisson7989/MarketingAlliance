...
/* Constants */
 ...
 #define guardREGISTER_IF_AVAILABLE 2
 #define guardREGISTER_ALWAYS 1
 #define guardLIC_REACT_SERVICE 8
 #define guardLIC_REACT_BOOT_SERVICE 4
 #define guardLIC_REACT_BLINK_CPU_LED 2
 #define guardLIC_REACT_LOGBOOK 1
 #define guardLIC_REACT_NONE 0
