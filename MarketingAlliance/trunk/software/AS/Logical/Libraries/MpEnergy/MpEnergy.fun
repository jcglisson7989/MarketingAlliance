...
FUNCTION_BLOCK MpEnergyCore (*mapp component for Energy consumption handling*) (* $GROUP=mapp,$CAT=Energy monitoring,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpEnergy.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpEnergyRegPower (*mapp component to add power consumption info from external device*) (* $GROUP=mapp,$CAT=Energy monitoring,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpEnergy.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets  function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpEnergyRegEnergy (*mapp component to add energy consumption info from external device*) (* $GROUP=mapp,$CAT=Energy monitoring,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpEnergy.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets  function block errors*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpEnergyCoreUI (*mapp component for Energy consumption analysis*) (* $GROUP=mapp,$CAT=Energy monitoring,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpEnergy.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets  function block errors*) (* *) (*#PAR#;*)
