...
FUNCTION_BLOCK MpOeeCore (*mapp function block which can be used for Oee calculation.*) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpOeeCoreConfig (*mapp component for read/write component configuration*) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpOeeCoreUI (*mapp function block which can be used for showing multiple OEE results as a trend.*) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpOeeTimelineUI (*mapp function block which can be used for showing multiple OEE results as a timeline.*) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpOeeTrendUI (*mapp function block which can be used for showing multiple OEE results as a trend.*) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpOeeListUI (*mapp function block which can be used for showing shift statistics in a list *) (* $GROUP=mapp,$CAT=Overall Equipment Efficiency,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpOee.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
