...
<Root LangModule="ailgcode" Version="1.0">
  ...
  <GCodes>
    ...
    <G_PJN GNum="22000" Alias="PJN" Inline="Yes" Group="220"> <!-- need inline because we're using path-synch -->
    ...
    <G_PJB GNum="22100" Alias="PJB" Inline="Yes" Group="220"> <!-- need inline because we're using path-synch -->
      <Arg Name="PathBusy" DataType="FLOAT" ref="busy_count"/>
      <Arg Name="PathStatus" DataType="FLOAT" ref="final_status"/>
      <Arg Name="PathErrLevel" DataType="FLOAT" ref="error_level"/>
      #job->group_id = 0;
