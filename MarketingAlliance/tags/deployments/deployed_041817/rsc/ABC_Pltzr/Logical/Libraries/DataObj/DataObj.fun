 ...
 ********************************************************************)
FUNCTION_BLOCK DatObjCreate					(*creates a data object*)
	VAR_INPUT
	...
	END_VAR
	VAR
		DatObjInternalStruct	:DatObjCreateInternal;	(*internal variable*)
		byState	:USINT;						(*internal variable*)		
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK DatObjWrite					(*writes to a data object*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
...
FUNCTION_BLOCK DatObjRead					(*reads from a data object*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
		ident	:UDINT;						(*ID of the data object*)
		Offset	:UDINT;						(*offset in the data area of the data object*)
...
FUNCTION_BLOCK DatObjDelete					(*deletes data objects*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
		ident	:UDINT;						(*ID of the data object*)
	END_VAR
	...
	END_VAR
	VAR
		DatObjInternalStruct	:DatObjDeleteInternal;	(*internal variable*)
		byState	:USINT;						(*internal variable*)		
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK DatObjMove					(*moves the storage space of a data object to a new target memory*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
		ident	:UDINT;						(*ID of the data object*)
	...
	END_VAR
	VAR
		DatObjInternalStruct	:DatObjCopyInternal;	(*internal variable*)
		byState	:USINT;						(*internal variable*)		
	END_VAR
END_FUNCTION_BLOCK

FUNCTION_BLOCK DatObjCopy					(*copies a data object*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
...
FUNCTION_BLOCK DatObjInfo					(*gives information about a data object*)
	VAR_INPUT	
		enable	:BOOL;						(*enables execution*)
...
FUNCTION_BLOCK DatObjChangeDate				(*changes the modification date of a data object*)
	VAR_INPUT
		enable	:BOOL;						(*enables execution*)
