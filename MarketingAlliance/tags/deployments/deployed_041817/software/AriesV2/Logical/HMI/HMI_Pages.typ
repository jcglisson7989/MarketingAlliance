...
TYPE
	HMI_Page_Enum : 
		( (*IMPORTANTNOTE: if the application is going to work correctly, you have to MANUALLY ADD all of the enumerations below AND make sure they line up with the hmi page numbers. *)
		HMI_00_STARTUP := 0,
